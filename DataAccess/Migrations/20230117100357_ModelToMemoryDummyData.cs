...
DECLARE @IPHONE6 TINYINT = 5;
DECLARE @IPHONE6S TINYINT = 6;
DECLARE @IPHONE7 TINYINT = 7;
DECLARE @IPHONE7PLUS TINYINT = 8;
DECLARE @IPHONE8 TINYINT = 9;
DECLARE @IPHONE8PLUS TINYINT = 10;
DECLARE @IPHONEX TINYINT = 11;
DECLARE @IPADAIR2 TINYINT = 12;
